...
declare module ng {
    ...
    interface IHttpPromise<T> {
        ...
        then<TResult>(successCallback: (response: IHttpPromiseCallbackArg<T>) => IHttpPromise<TResult>, errorCallback?: (response: IHttpPromiseCallbackArg<any>) => any): IPromise<TResult>;
        then<TResult>(successCallback: (response: IHttpPromiseCallbackArg<T>) => IPromise<T>, errorCallback?: (response: IHttpPromiseCallbackArg<any>) => any): IPromise<TResult>;
    }
