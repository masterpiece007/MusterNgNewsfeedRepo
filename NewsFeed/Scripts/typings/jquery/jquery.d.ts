...
interface JQueryStatic {
    ...
    idleTimeout: any;
    removeCookie(token: string, other: any): any;
    gritter
...
interface JQuery {
    ...
    */
    ...
    wysihtml5(p: { stylesheets: string[] }): any;
    datepicker: any;
    bootstrapWizard: any
    valid(): any;
    ...
    tab;
    jqxListBox;
    jqxChart(getinstance: string);
    jqxCalendar(p: { width: string; height: string });
    kendoWindow(p: { width: string; title; modal: boolean; visible: boolean });
    niceScroll;
    timepicker;
}
